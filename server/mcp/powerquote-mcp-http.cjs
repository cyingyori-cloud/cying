...
const tools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        moduleFireFilter: { type: 'string', enum: ['全部', '带消防', '不带消防'], description: '模组消防过滤，可选值：全部、带消防、不带消防。默认 全部' },
        cabinetFireFilter: { type: 'string', enum: ['全部', '带消防', '不带消防'], description: '柜体消防过滤，可选值：全部、带消防、不带消防。默认 全部' },
        lineTypeFilter: { type: 'string', enum: ['全部', '2线', '3线'], description: '线路类型过滤，可选值：全部、2线、3线。默认 全部' },
      },
